...
@ListenerFor(sourceClass = VentureMenu.class, systemEventClass = PostAddToViewEvent.class)
public class VentureMenu extends AbstractMenu implements Widget,ComponentSystemEventListener {

    public static final String COMPONENT_TYPE = "org.primefaces.component.VentureMenu";
    public static final String COMPONENT_FAMILY = "org.primefaces.component";
    private static final String DEFAULT_RENDERER = "org.primefaces.component.VentureMenuRenderer";
